...
const promoRoutes = require("./routers/Promovideo");
...
app.use("/smartglobal/promos", promoRoutes);
app.use("/smartglobal/blogs", blogRoutes);
app.use("/smartglobal/activity", activityRoutes);
